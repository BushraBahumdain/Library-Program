 ...
 * @author REEN
 */
public class Library_info1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 200, 200, 30));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 280, 270, 290));

        big.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        jPanel1.add(big, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 230, 420, 40));

        jButton11.setBackground(new java.awt.Color(73, 84, 100));
        jButton11.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jButton11.setText("تعديل البيانات");
        jButton11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton11ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton11, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 590, 250, 60));
        ...
        jPanel1.add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 590, 250, 60));
        ...
        jPanel1.add(jButton13, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 590, 250, 60));

        jLabel12.setFont(new java.awt.Font("Dialog", 1, 48)); // NOI18N
        jLabel12.setText("بيانات المكتبة");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 110, 220, -1));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        // TODO add your handling code here:
        if (d.getText().isEmpty() || q.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, " الرجاء تعبئة جميع الحقول ");

        } else {
            big.disable();
            String date = d.getText();
            String qnt = q.getText();
            int i = Bt.edit(Bt.type, Integer.parseInt(date), Bt.ID, Integer.parseInt(qnt));
            JOptionPane.showMessageDialog(this, " تمت عملية تعديل البيانات بنجاح");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Library_info1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
