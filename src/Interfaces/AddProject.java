...
public class AddProject extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("*عنوان المشروع");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 210, 150, 30));
        ...
        jPanel1.add(pages, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 340, 190, 40));

        jLabel7.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel7.setText("عدد الصفحات");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 310, 120, 30));

        jLabel11.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel11.setText("نوع التصنيف");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 210, 120, 30));
        ...
        jPanel1.add(year, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 340, 200, 40));

        jLabel10.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel10.setText("سنة الاعداد");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 310, 100, 30));

        author.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        jPanel1.add(author, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 340, 360, 40));

        jLabel2.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel2.setText("* معد البحث ");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 310, 120, 30));

        judg.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        jPanel1.add(judg, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 440, 360, 40));

        jLabel4.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel4.setText("اسماء لجنة التحكيم");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 410, 160, 30));

        jLabel8.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel8.setText("* عدد النسخ ");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 410, 120, 30));

        copy.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        jPanel1.add(copy, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 440, 200, 40));
        ...
        jLabel12.setText("إضافة مشروع");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 120, 240, -1));
    ...
    private void jButton9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton9MouseClicked
        ...
        if (this.label.getText().trim().isEmpty() || this.c_num.getText().trim().isEmpty()
                || this.copy.getText().trim().isEmpty() || this.author.getText().trim().isEmpty()) {
        ...
        if (check == true) {
            ...
            if (year.getText().trim().isEmpty()) {
                ...
                match = pattern.matcher(String.valueOf(year.getText().trim()));

                val = match.find();
                if (val == true) {

                    JOptionPane.showMessageDialog(this, "يجب ادخال ارقام فقط في سنة الاعداد  ");
                } else {
                    c3 = true;
                }
            }
        ...
        if (done == true) {
            ...
            if (resutl == JOptionPane.YES_OPTION) {
                // String Classification_number, int Number_Of_actuel_copies, String Judges, String Relase_date,
                //int Pages, String Label_Type, String Label, String Author) {

                Project p = new Project(this.c_num.getText().trim(), Integer.parseInt(this.copy.getText().trim()),
                        this.judg.getText().trim(), this.year.getText().trim(), Integer.parseInt(this.pages.getText().trim()),
                        this.label_type.getText().trim(), this.label.getText().trim(), this.author.getText().trim());
                p.addProject();
                int id = p.getProject_ID(label.getText().trim());
                JOptionPane.showMessageDialog(this, "عنوان المشروع :" + this.label.getText() + "\n"
                        + "الرقم العام: " + id);
