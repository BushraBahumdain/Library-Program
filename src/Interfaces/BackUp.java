...
String path=null;
    ...
    private void initComponents() {
        ...
        backup.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        backup.setText("نسخ الان");
        backup.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                backupActionPerformed(evt);
            }
        });
        jPanel1.add(backup, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 340, -1, -1));

        file.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        file.setText("استعراض");
        file.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fileActionPerformed(evt);
            }
        });
        jPanel1.add(file, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 340, -1, -1));

        filePath.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        jPanel1.add(filePath, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 270, 570, 40));

        filePath1.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        jPanel1.add(filePath1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 490, 570, 40));

        file1.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        file1.setText("استعراض");
        file1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                file1ActionPerformed(evt);
            }
        });
        jPanel1.add(file1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 560, -1, -1));

        restore.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        restore.setText("استعاده");
        restore.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                restoreActionPerformed(evt);
            }
        });
        jPanel1.add(restore, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 560, 110, -1));
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        jLabel12.setFont(new java.awt.Font("Dialog", 1, 48)); // NOI18N
        jLabel12.setText("النسخ الإحتياطي");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 110, 270, -1));

        jLabel2.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel2.setText("نسخ احتياطي");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 240, 120, 30));

        jLabel4.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel4.setText("استعادة نسخة احتياطية");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 460, 190, 30));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/insert_book - Copy.png"))); // NOI18N
    ...
    private void restoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_restoreActionPerformed
        int x=filePath1.getText().length();
         if(x>0){
            String URL = "jdbc:mysql://localhost:3306/library";
            String USERNAME = "root"; // use your username of Mysql server
            String PASSWORD = "bushra"; // use your password of Mysql server

            String [] restoreComand=new String[]{"C:\\Program Files\\MySQL\\MySQL Server 8.0\\bin\\mysql.exe","--user="+USERNAME,"--password="+PASSWORD,"-e","source "+path};
            //    System.out.println(path);
            Process pr;
            try {
                // TODO add your handling code here:
                pr=Runtime.getRuntime().exec(restoreComand);

                int pComplete=pr.waitFor();
                System.out.println(pComplete);
                if(pComplete==0){
                    JOptionPane.showMessageDialog(rootPane, "تم استعادة النسخة الاحتياطية بنجاح");
                }else{

                    JOptionPane.showMessageDialog(rootPane, "لم تتم الاستعادة بنجاح ، الرجاء المحاولة مجددا");
              ...
              JOptionPane.showMessageDialog(rootPane, "الرجاء اختيار موقع الملف المراد استرداد البيانات منه");
    ...
    private void backupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backupActionPerformed
        ...
        String USERNAME = "root"; // use your username of Mysql server
        String PASSWORD = "bushra"; // use your password of Mysql server
        int x=filePath.getText().length();
        if(x>0){
            try {
                Runtime run = Runtime.getRuntime();

                // String executeCmd = "mysqldump -u" + USERNAME + " -p" + PASSWORD + " --database " +  + " -r " + savePath;
                pr=run.exec("C:\\Program Files\\MySQL\\MySQL Server 8.0\\bin\\mysqldump.exe -uroot -pbushra --add-drop-database -B library -r"+path);
                int pComplete=pr.waitFor();
                if(pComplete==0){
                    JOptionPane.showMessageDialog(rootPane, "تم انشاء نسخة احتياطية بنجاح");
                }else{
                    JOptionPane.showMessageDialog(rootPane, "فشل النسخ الاحتياطي، الرجاء المحاولة مجددا ");
            ...
            JOptionPane.showMessageDialog(rootPane, "الرجاء اختيار موقع للملف");
