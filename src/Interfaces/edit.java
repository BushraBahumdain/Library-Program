...
public class edit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(dow, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 240, -1, -1));
        ...
        jPanel1.add(msg, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 240, -1, -1));
        ...
        jPanel1.add(project, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 240, -1, -1));
        ...
        jPanel1.add(book, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 240, -1, -1));
        ...
        jPanel1.add(jButton11, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 570, 250, 60));

        copy.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        jPanel1.add(copy, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 500, 370, 40));

        jLabel10.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel10.setText("ادخلي عدد النسخ الجديد");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 450, 190, 30));

        ID.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        jPanel1.add(ID, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 390, 370, 40));

        jLabel9.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel9.setText("ادخلي الرقم العام للوعاء لمراد التعديل فيه");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 340, 370, 30));

        jLabel14.setFont(new java.awt.Font("Dialog", 1, 48)); // NOI18N
        jLabel14.setText("تعديل عدد النسخ للوعاء ");
        jLabel14.setToolTipText("");
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 130, 430, -1));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if (dow.isSelected()) {
            ...
            num= j.updateJournalRecord1(Integer.parseInt(this.copy.getText().trim()), Integer.parseInt(this.ID.getText().trim()));
            ...
            if (num == 1){
                ...
                JOptionPane.showMessageDialog(this, " لايمكن التعديل عند وجود مستعيرين للمصدر");   
            }else{
                JOptionPane.showMessageDialog(this, " حدث خطأ ما!");
            }
//===============================================================================            
        }else if (msg.isSelected()) {
            Messag m = new Messag();
            num = m.updateMsgRecord1(Integer.parseInt(this.copy.getText().trim()), Integer.parseInt(this.ID.getText().trim()));
...
//===============================================================================            
            ...
            Book b = new Book();
            num = b.updateBookRecord1(Integer.parseInt(this.copy.getText().trim()), Integer.parseInt(this.ID.getText().trim()));
...
//===============================================================================            
            ...
            num = p.updateProjectRecord1(Integer.parseInt(this.copy.getText().trim()), Integer.parseInt(this.ID.getText().trim()));
