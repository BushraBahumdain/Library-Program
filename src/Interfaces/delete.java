...
public class delete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dow = new javax.swing.JRadioButton();
        ...
        jPanel1.add(jButton11, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 520, 270, 60));

        jLabel9.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel9.setText("ادخلي الرقم العام للوعاء المراد حذفه");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 320, -1, 30));

        id.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        jPanel1.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 360, 330, 40));
        ...
        jPanel1.add(book, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 190, -1, -1));

        project.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        project.setText("مشروع");
        project.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                projectActionPerformed(evt);
            }
        });
        jPanel1.add(project, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 190, -1, -1));
        ...
        jPanel1.add(msg, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 190, -1, -1));

        dow.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        dow.setText("دورية");
        dow.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                dowActionPerformed(evt);
            }
        });
        jPanel1.add(dow, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 190, -1, -1));

        jLabel14.setFont(new java.awt.Font("Dialog", 1, 48)); // NOI18N
        jLabel14.setText("حذف وعاء من المكتبة ");
        jLabel14.setToolTipText("");
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 100, 430, -1));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if (dow.isSelected()) {
            ...
            found=j.searchjornalID(Integer.parseInt(this.id.getText().trim()));
            if(found== true){
              String label=j.searchjournallabel(Integer.parseInt(this.id.getText().trim()));
              j.deleteJournalRecord(Integer.parseInt(this.id.getText().trim()));
              JOptionPane.showMessageDialog(this, "تم حذف  " + label + " بنجاح");
              
            }else if (found == false) {
                JOptionPane.showMessageDialog(this, "الرجاء التحقق من الرقم العام");
            ...
            Messag m = new Messag();
            found =m.searchletterID(Integer.parseInt(this.id.getText().trim()));
            if(found== true){
          String label=m.searchletterlabel(Integer.parseInt(this.id.getText().trim()));
          JOptionPane.showMessageDialog(this, "تم حذف  " + label + " بنجاح");
            }else if (found == false) {
                JOptionPane.showMessageDialog(this, "الرجاء التحقق من الرقم العام");

             }
            m.deleteBookRecord(Integer.parseInt(this.id.getText().trim()));
        }else if (book.isSelected()) {
            Book b = new Book();
            found = b.searchBookID(Integer.parseInt(this.id.getText().trim()));
            if (found == true) {
                String label = b.searchbooklabel(Integer.parseInt(this.id.getText().trim()));
                b.deleteBookRecord(Integer.parseInt(this.id.getText().trim()));
                JOptionPane.showMessageDialog(this, "تم حذف  " + label + " بنجاح");
            ...
            found=p.searchprojectID(Integer.parseInt(this.id.getText().trim()));
            if(found == true){
             String label = p.searchprojectlabel(Integer.parseInt(this.id.getText().trim()));
              p.deleteProjectRecord(Integer.parseInt(this.id.getText().trim()));
              JOptionPane.showMessageDialog(this, "تم حذف  " + label + " بنجاح");
            }else if (found == false) {
                JOptionPane.showMessageDialog(this, "الرجاء التحقق من الرقم العام");
             }
    ...
    private void dowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dowActionPerformed
        // TODO add your handling code here:
        if (dow.isSelected()) {
            book.setSelected(false);
            msg.setSelected(false);
    ...
    }//GEN-LAST:event_dowActionPerformed
    ...
    private javax.swing.JRadioButton dow;
